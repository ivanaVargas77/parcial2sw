...
<head>
    ...
    <!-- You can  cambiar el color del tema -->
    <link href="{{asset('plantilla/material/css/colors/pink.css')}}" id="theme" rel="stylesheet">
    @laravelPWA
    @stack('arriba')
</head>
    ...
    <div id="main-wrapper">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand ligh" href="{{url('admin')}}">
                        ...
                        <!-- Logo text -->
                        <span>
                            <b class="light-logo"> ELECCIONES</b> <!-- nombre al lado del icono-->
                        </span> </a>
                </div>
                <!-- ============================================================== -->
                <!-- End Logo -->
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            document.getElementById('logout-form').submit();">
                                            <i class="fa fa-power-off"></i> <!-- el cerrar sesion si apreto el nombre del admin -->
                                                Cerrar Sesion
                                        </a>
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                <!-- User profile -->
<!-- ACA VEREMOS LA COLUMNA QUE APARECE A LA IZQUIERDA -->
